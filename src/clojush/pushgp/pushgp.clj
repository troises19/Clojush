...
(def push-argmap
  (atom (sorted-map
          ...
          :weighted-lexicase-bias :variance ;; If using weighted-lexicase, the chosen bias to weight by. Options are :number-of-zeros, :sum, :average, :number-of-nonzeros, :variance
